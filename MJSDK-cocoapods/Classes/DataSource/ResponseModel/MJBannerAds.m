...
//#warning error report
        if (!value || [value length] <= 5) {
            MJExceptionReport *report = [MJExceptionReport reportWithADSpaceID:@"" code:kMJSDKERRORElementsParseFailure description:[NSString stringWithFormat:@"elements parse failure!\n\nelements:%@", value]];
