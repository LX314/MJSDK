...
#define kRectWidth(v)                         CGRectGetWidth(v)
#define kRectHeight(v)                        CGRectGetHeight(v)

#define kRectX(v)                                CGRectGetMinX(v)
#define kRectY(v)                                CGRectGetMinY(v)
#define kRectMidX(v)                                CGRectGetMidX(v)
#define kRectMidY(v)                                CGRectGetMidY(v)
#define kRectMaxX(v)                                CGRectGetMaxX(v)
#define kRectMaxY(v)                                CGRectGetMaxY(v)

#define kRectSetWidth(__rect__, w)                  CGRectMake(kRectX(__rect__), kRectY(__rect__), w, kRectHeight(__rect__))
#define kRectSetHeight(__rect__, h)                 CGRectMake(kRectX(__rect__), kRectY(__rect__), kRectWidth(__rect__), h)
#define kRectSetX(__rect__, x)                        CGRectMake(x, kRectY(__rect__), kRectWidth(__rect__), kRectHeight(__rect__))
#define kRectSetY(__rect__, y)                        CGRectMake(kRectX(__rect__), y, kRectWidth(__rect__), kRectHeight(__rect__))
#define kRectSetSize(__rect__, w, h)              CGRectMake(kRectX(__rect__), kRectY(__rect__), w, h)
#define kRectSetOrigin(__rect__, x, y)           CGRectMake(x, y, RectWidth(__rect__), kRectHeight(__rect__))
