...
+ (void)updateGlobalConf:(NSDictionary *)dictGlobalConf {
    ...
    kMJSDKCurrentDefaultADVersion = globalConf.defaultAdVersion;
    {
        ...
        kMJSDKInterstitialRequestCount = globalConf.adRequestCount;
...
#warning TODO delete it on release version.
    kMJSDKScrollInterval = 5.f;
    kMJSDKExposureTimeInterval = 1.f;
}
